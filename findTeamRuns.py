...
CSVROWS = 6191 #how many lines the coopCategories.csv has. To make better time predictions
...
with open("coopCategories.csv","r", encoding = 'utf-8') as file:
    ...
    with open("allRuns.csv","w", encoding = 'utf-8') as file2:
        writer = csv.writer(file2,delimiter = ';')
        with open("guests.csv","w", encoding = 'utf-8') as file3:
            ...
            for categoryID in reader:
                ...
                if n%10 == 0:
                    ...
                    singleDuration =  (end - begin)/10
                    duration = (CSVROW-n) * singleDuration
                    print(f"{n*100//CSVROW}% : {n} : {categoryID} : {r} : {pT(duration)}")
                    begin = time()
